...
X_00 = [-24 + i*d for i in range(len(pressure_00))]
...
X_10 = [-24 + i*d for i in range(len(pressure_10))]
...
X_20 = [-24 + i*d for i in range(len(pressure_20))]
...
X_30 = [-24 + i*d for i in range(len(pressure_30))]
...
X_40 = [-24 + i*d for i in range(len(pressure_40))]
...
X_50 = [-24 + i*d for i in range(len(pressure_50))]
...
X_60 = [-24 + i*d for i in range(len(pressure_60))]
...
X_70 = [-24 + i*d for i in range(len(pressure_70))]
